...
export const LoadingMine = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 32 32"
    width="1em"
    height="1em"
  ...
  >
    <path 
      fill="currentColor"
      d="M31.813 3.653a4.777 4.777 0 00-3.339-1.52h-.008a4.712 4.712 0 00-3.143 1.021l.01-.007C24 1.974 22.213 1.4 21.04 2.507L19.893 3.6a15.394 15.394 0 015.949 5.482l.037.064.787-.693c1.16-1.093.747-2.84-.307-4.24a3.31 3.31 0 011.982-.654c.965 0 1.834.41 2.442 1.065l.002.002c.127.139.31.227.513.227h.008a.676.676 0 00.48-.2.705.705 0 00.026-1zM26 17.093c0 7.18-5.82 13-13 13s-13-5.82-13-13 5.82-13 13-13 13 5.82 13 13z"
    />
  </svg>
)